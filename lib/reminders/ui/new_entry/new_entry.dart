import 'dart:math';
import 'package:amun/common/convert_time.dart';
import 'package:amun/reminders/models/errors.dart';
import 'package:amun/reminders/models/medicine.dart';
import 'package:amun/reminders/models/medicine_type.dart';
...
class _NewEntryState extends State<NewEntry> {
  ...
  Future onSelectNotification(String payload) async {
    ...
    await Navigator.push(
      context,
      new MaterialPageRoute(builder: (context) => RemindersScreen()),
    );
  }
